...
class VegetablesScanScreen extends StatefulWidget {
  @override
  _VegetablesScanScreenState createState() => _VegetablesScanScreenState();
}

class _VegetablesScanScreenState extends State<VegetablesScanScreen> {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        AppTranslations.get('scan_vegetables'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      Text(
                        AppTranslations.get('position_vegetables'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                      ...
                      GestureDetector(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppTranslations.get('scanning_vegetables')),
