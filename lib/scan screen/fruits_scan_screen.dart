...
class FruitsScanScreen extends StatefulWidget {
  @override
  _FruitsScanScreenState createState() => _FruitsScanScreenState();
}

class _FruitsScanScreenState extends State<FruitsScanScreen> {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        AppTranslations.get('scan_fruits'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      Text(
                        AppTranslations.get('position_fruits'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                      ...
                      GestureDetector(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppTranslations.get('scanning_fruits')),
