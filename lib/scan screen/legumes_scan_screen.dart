...
class LegumesScanScreen extends StatefulWidget {
  @override
  _LegumesScanScreenState createState() => _LegumesScanScreenState();
}

class _LegumesScanScreenState extends State<LegumesScanScreen> {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        AppTranslations.get('scan_legumes'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      Text(
                        AppTranslations.get('position_legumes'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                      ...
                      GestureDetector(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppTranslations.get('scanning_legumes')),
