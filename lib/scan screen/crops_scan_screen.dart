...
class CropsScanScreen extends StatefulWidget {
  @override
  _CropsScanScreenState createState() => _CropsScanScreenState();
}

class _CropsScanScreenState extends State<CropsScanScreen> {
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      Text(
                        AppTranslations.get('scan_crops'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 20,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 30),
                      Text(
                        AppTranslations.get('position_crops'),
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 15,
                      ...
                      GestureDetector(
                        onTap: () {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(AppTranslations.get('scanning_crops')),
