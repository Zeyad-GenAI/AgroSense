...
class ForgetPasswordThreeScreen extends StatefulWidget {
  @override
  _ForgetPasswordThreeScreenState createState() => _ForgetPasswordThreeScreenState();
}

class _ForgetPasswordThreeScreenState extends State<ForgetPasswordThreeScreen>
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        borderSide: BorderSide(color: Color(0xFFEAF8BD), width: 1.5),
                      ),
                      enabledBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: Color(0xFFEAF8BD).withOpacity(0.6), width: 1.5),
                      ),
                      focusedBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: BorderSide(color: Color(0xFFEAF8BD), width: 1.8),
                      ),
                      prefixIcon: Icon(Icons.lock_outline, color: Color(0xFFEAF8BD).withOpacity(0.7), size: 20),
